...
with open(os.path.join(os.path.abspath('../contamiNation'),'outputbatch_0_cut.json')) as results:
...
json.dump(geojson_list, open(os.path.join(os.path.abspath('../contamiNation/geocoding/'),'test_markers.json'),'w'), indent=4)
